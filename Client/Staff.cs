...
namespace Client
{
    public partial class Staff : Form
    {
        ...
        {
            dataGridView1.DataSource = client.Take_table_table1(Settings.Default["token"].ToString());
            offset = 0;
            max = client.Count_table(dataGridView1.DataSource.ToString(), Settings.Default["token"].ToString());
        }
        ...
        {
            dataGridView1.DataSource = client.Take_table_table2(Settings.Default["token"].ToString());
            offset = 0;
            max = client.Count_table(dataGridView1.DataSource.ToString(), Settings.Default["token"].ToString());
        }
        ...
        {
            dataGridView1.DataSource = client.Take_table_table3(Settings.Default["token"].ToString());
            offset = 0;
            max = client.Count_table(dataGridView1.DataSource.ToString(), Settings.Default["token"].ToString());
        }
    }
